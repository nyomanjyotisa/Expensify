...
const styles = (theme: ThemeColors) =>
    ({
        ...
        TestToolsNavigatorInnerView: (shouldUseNarrowLayout: boolean) => ({
            ...
            borderRadius: shouldUseNarrowLayout ? variables.componentBorderRadiusLarge : 16,
            borderTopLeftRadius: shouldUseNarrowLayout ? variables.componentBorderRadiusLarge : 16,
            borderTopRightRadius: shouldUseNarrowLayout ? variables.componentBorderRadiusLarge : 16,
            alignSelf: 'center',
            backgroundColor: theme.appBG,
            overflow: 'hidden',
        }),
