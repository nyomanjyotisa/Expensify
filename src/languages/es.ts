...
${amount} para ${merchant} - ${date}`,
    ...
    validateCodeForm: {
        ...
        avoidScamsMessage: '<strong>Evita las estafas. No compartas tu código con nadie.</strong> Nuestro equipo nunca te llamará, enviará mensajes de texto ni correos electrónicos para solicitarte este código.',
