...
${amount} pour ${merchant} - ${date}`,
    ...
    validateCodeForm: {
        ...
        avoidScamsMessage:
            '<strong>Évitez les arnaques. Ne partagez votre code avec personne.</strong> Notre équipe ne vous appellera jamais et ne vous enverra jamais de SMS ni d’e-mail pour vous demander ce code.',
