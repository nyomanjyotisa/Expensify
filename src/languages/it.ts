...
${amount} per ${merchant} - ${date}`,
    ...
    validateCodeForm: {
        ...
        avoidScamsMessage:
            '<strong>Evita le truffe. Non condividere il tuo codice con nessuno.</strong> Il nostro team non ti chiamerà, non ti invierà SMS né e-mail per chiederti questo codice.',
