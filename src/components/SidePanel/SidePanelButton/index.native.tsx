...
function SidePanelButton({style}: SidePanelButtonProps) {
    ...
    const {shouldHideHelpButton} = useSidePanelState(); //1
    const isViewingSidePanelTargetReport = useIsViewingSidePanelTargetReport(); //2
    ...
    if (shouldHideHelpButton || isViewingSidePanelTargetReport) { //3
        return null;
    }
